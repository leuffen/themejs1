...
defineSection('leistungen2', SectionLayoutGroup.Page)`

Example of a Leistungen page with Accordions. Use Accordions if sections have multiple items with additional information.

`;


example("Leistungen for Pxychotherapie")`
## Vorsorge
